...
const NAV_ITEMS = [
  ...
  {
    key: "nav.account", href: "/dashboard",
    icon: (
      <svg className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
            ...
            >
              ...
              {special ? (
                ...
                <span className="flex items-center justify-center">
                  {/* Cart badge */}
                  {isCart && cartCount > 0 && (
                    <span className="absolute top-1.5 right-[calc(50%-16px)] h-4 min-w-4 px-1 rounded-full bg-green-600 text-[9px] font-bold text-white flex items-center justify-center">
